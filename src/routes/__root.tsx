...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Spendly is a voice-first, UPI-native expense tracker for India — log chai, auto, lunch and QR payments in seconds, with streaks, goals, and a 9 PM shock report." },
      { name: "author", content: "Spendly" },
      { property: "og:site_name", content: "Spendly" },
      { property: "og:title", content: "Spendly — Your daily expenses, tracked in 3 seconds" },
      { property: "og:description", content: "Voice-first, UPI-native expense tracker for India. Log chai, auto, lunch and QR payments in seconds. Streaks, goals, and a 9 PM shock report." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Spendly — Your daily expenses, tracked in 3 seconds" },
