...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Voice-first, UPI-native expense tracker for India. Log chai, auto, lunch in seconds." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Spendly — Your daily expenses, tracked in 3 seconds" },
      { name: "twitter:description", content: "Voice-first, UPI-native expense tracker for India. Log chai, auto, lunch in seconds." },
